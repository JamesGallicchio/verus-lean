...
#generate_verus_funcs ↑"verus/source/vstd.json" {{
  ...
  theorem vstd.arithmetic.internals.div_internals_nonlinear.lemma_div_of0 (d : Int) : !d = 0 → 0 / d = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals_nonlinear.lemma_div_by_self (d : Int) : !d = 0 → d / d = 1 ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals_nonlinear.lemma_small_div («no%param» : Int) :
      (∀ (x : Int) (d : Int), (0 ≤ x ∧ x < d) ∧ d > 0 → x / d = 0) ∧ True :=
    sorry
        ...
        n > 0 →
          (∀ (i : Int), 0 ≤ i ∧ i < n → f i) →
            (∀ (i : Int), i ≥ 0 ∧ f i → f (vstd.math.add i n)) →
              (∀ (i : Int), i < n ∧ f i → f (vstd.math.sub i n)) → f x ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.internals.mul_internals.lemma_mul_induction_auto (x : Int) (f : Int → Bool) :
      (vstd.arithmetic.internals.mul_internals.mul_auto 0 →
        ...
        vstd.arithmetic.internals.mul_internals.mul_auto 0 ∧ f x ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_inequality (x : Int) (y : Int) (z : Int) :
      x ≤ y → z ≥ 0 → x * z ≤ y * z ∧ True :=
    sorry
          ...
          (∀ (i : Int) (j : Int), i ≥ 0 ∧ f i j → f (vstd.math.add i n) j) →
            (∀ (i : Int) (j : Int), j ≥ 0 ∧ f i j → f i (vstd.math.add j n)) →
              (∀ (i : Int) (j : Int), i < n ∧ f i j → f (vstd.math.sub i n) j) →
                (∀ (i : Int) (j : Int), j < n ∧ f i j → f i (vstd.math.sub j n)) →
                  (∀ (i : Int) (j : Int), f i j) ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals.lemma_div_auto_plus (n : Int) :
      n > 0 → vstd.arithmetic.internals.div_internals.div_auto_plus n ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals.lemma_div_auto_minus (n : Int) :
      n > 0 → vstd.arithmetic.internals.div_internals.div_auto_minus n ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals.lemma_div_auto (n : Int) :
      n > 0 → vstd.arithmetic.internals.div_internals.div_auto n ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.div_internals.lemma_div_induction_auto (n : Int) (x : Int) (f : Int → Bool) :
      n > 0 →
        (vstd.arithmetic.internals.div_internals.div_auto n →
          ...
          vstd.arithmetic.internals.div_internals.div_auto n ∧ f x ∧ True :=
    sorry
      ...
      n > 0 →
        (vstd.arithmetic.internals.div_internals.div_auto n →
            ((∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ i < n → f i) ∧
                ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ f i → f (i + n)) ∧
              ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le (i + 1) n ∧ f i → f (i - n)) →
          vstd.arithmetic.internals.div_internals.div_auto n ∧ (∀ (i : Int), f i) ∧ True :=
    sorry
      ...
      n > 0 →
        (vstd.arithmetic.internals.mod_internals.mod_auto n →
            ((∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ i < n → f i) ∧
                ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ f i → f (i + n)) ∧
              ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le (i + 1) n ∧ f i → f (i - n)) →
          vstd.arithmetic.internals.mod_internals.mod_auto n ∧ f x ∧ True :=
    sorry
      ...
      n > 0 →
        (vstd.arithmetic.internals.mod_internals.mod_auto n →
            ((∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ i < n → f i) ∧
                ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ f i → f (i + n)) ∧
              ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le (i + 1) n ∧ f i → f (i - n)) →
          vstd.arithmetic.internals.mod_internals.mod_auto n ∧ (∀ (i : Int), f i) ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.mul_internals.lemma_mul_properties_internal_prove_mul_auto («no%param» : Int) :
      vstd.arithmetic.internals.mul_internals.mul_auto 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.internals.mul_internals.lemma_mul_induction_auto_forall (f : Int → Bool) :
      (vstd.arithmetic.internals.mul_internals.mul_auto 0 →
          (f 0 ∧ ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le 0 i ∧ f i → f (i + 1)) ∧
            ∀ (i : Int), vstd.arithmetic.internals.general_internals.is_le i 0 ∧ f i → f (i - 1)) →
        vstd.arithmetic.internals.mul_internals.mul_auto 0 ∧ (∀ (i : Int), f i) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_is_div_recursive (x : Int) (d : Int) :
      0 < d → vstd.arithmetic.internals.div_internals.div_recursive x d = x / d ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_by_self (d : Int) : !d = 0 → d / d = 1 ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_of0 (d : Int) : !d = 0 → 0 / d = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics (x : Int) :
      (!x = 0 → 0 / x = 0) ∧ x / 1 = x ∧ (!x = 0 → x / x = 1) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_1 (x : Int) : (!x = 0 → 0 / x = 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_2 (x : Int) : x / 1 = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_3 (x : Int) : (!x = 0 → x / x = 1) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_4 (x : Int) (y : Int) : (x ≥ 0 ∧ y > 0 → x / y ≥ 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_pos_is_pos (x : Int) (d : Int) : 0 ≤ x → 0 < d → 0 ≤ x / d ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_is_ordered (x : Int) (y : Int) (z : Int) :
      x ≤ y → 0 < z → x / z ≤ y / z ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_is_ordered_by_denominator (x : Int) (y : Int) (z : Int) :
      0 ≤ x → 1 ≤ y ∧ y ≤ z → x / y ≥ x / z ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_5 (x : Int) (y : Int) : (x ≥ 0 ∧ y > 0 → x / y ≤ x) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_basics_prove_auto («no%param» : Int) :
      (∀ (x : Int), !x = 0 → 0 / x = 0) ∧
        (∀ (x : Int), x / 1 = x) ∧
          (∀ (x : Int) (y : Int), x ≥ 0 ∧ y > 0 → x / y ≥ 0) ∧
            (∀ (x : Int) (y : Int), x ≥ 0 ∧ y > 0 → x / y ≤ x) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_small_div_converse (x : Int) (d : Int) :
      ((0 ≤ x ∧ 0 < d) ∧ x / d = 0 → x < d) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_non_zero (x : Int) (d : Int) : x ≥ d ∧ d > 0 → x / d > 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_is_strictly_smaller (x : Int) (d : Int) :
      0 < x → 1 < d → x / d < x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_dividing_sums (a : Int) (b : Int) (d : Int) (r : Int) :
      0 < d → r = a % d + b % d - (a + b) % d → d * ((a + b) / d) - r = d * (a / d) + d * (b / d) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_plus_one (x : Int) (d : Int) : 0 < d → 1 + x / d = (d + x) / d ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_minus_one (x : Int) (d : Int) :
      0 < d → 0 - 1 + x / d = (0 - d + x) / d ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_basic_div_specific_divisor (d : Int) :
      0 < d → (∀ (x : Int), 0 ≤ x ∧ x < d → x / d = 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_basic_div : (∀ (x : Int) (d : Int), 0 ≤ x ∧ x < d → x / d = 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_decreases (x : Int) (d : Int) : 0 < x → 1 < d → x / d < x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_nonincreasing (x : Int) (d : Int) : 0 ≤ x → 0 < d → x / d ≤ x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_small_mod (x : Nat) (m : Nat) : x < m → 0 < m → Int.natAbs (x % m) = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mul_is_distributive_auto («no%param» : Int) :
      (∀ (x : Int) (y : Int) (z : Int), x * (y + z) = x * y + x * z) ∧
        (∀ (x : Int) (y : Int) (z : Int), (y + z) * x = y * x + z * x) ∧
          (∀ (x : Int) (y : Int) (z : Int), x * (y - z) = x * y - x * z) ∧
            (∀ (x : Int) (y : Int) (z : Int), (y - z) * x = y * x - z * x) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mul_is_commutative_auto («no%param» : Int) :
      (∀ (x : Int) (y : Int), x * y = y * x) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_basics_1 (x : Int) : 0 * x = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_basics_2 (x : Int) : x * 0 = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_basics_3 (x : Int) : x * 1 = x ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_basics_4 (x : Int) : 1 * x = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mul_basics_auto («no%param» : Int) :
      (∀ (x : Int), 0 * x = 0) ∧
        (∀ (x : Int), x * 0 = 0) ∧ (∀ (x : Int), x * 1 = x) ∧ (∀ (x : Int), 1 * x = x) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_strictly_positive (x : Int) (y : Int) : (0 < x ∧ 0 < y → 0 < x * y) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_is_associative (x : Int) (y : Int) (z : Int) : x * (y * z) = x * y * z ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mul_is_associative_auto («no%param» : Int) :
      (∀ (x : Int) (y : Int) (z : Int), x * (y * z) = x * y * z) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_part_bound1 (a : Int) (b : Int) (c : Int) :
      0 ≤ a → 0 < b → 0 < c → 0 < b * c ∧ b * (a / b) % (b * c) ≤ b * (c - 1) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_self_0 (m : Int) : m > 0 → m % m = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_twice (x : Int) (m : Int) : m > 0 → x % m % m = x % m ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.div_mod.lemma_mod_is_mod_recursive (x : Int) (m : Int) :
      m > 0 → vstd.arithmetic.internals.mod_internals.mod_recursive x m = x % m ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_is_mod_recursive_auto («no%param» : Int) :
      (∀ (x : Int) (d : Int), d > 0 → vstd.arithmetic.internals.mod_internals.mod_recursive x d = x % d) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_equality_converse (m : Int) (x : Int) (y : Int) :
      !m = 0 → m * x = m * y → x = y ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_denominator (x : Int) (c : Int) (d : Int) :
      0 ≤ x → 0 < c → 0 < d → !c * d = 0 ∧ x / c / d = x / (c * d) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_basics (x : Int) : 0 * x = 0 ∧ x * 0 = 0 ∧ x * 1 = x ∧ 1 * x = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_multiples_vanish_fancy (x : Int) (b : Int) (d : Int) :
      0 < d → 0 ≤ b ∧ b < d → (d * x + b) / d = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_multiples_vanish (x : Int) (d : Int) : 0 < d → d * x / d = x ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_div_by_multiple (b : Int) (d : Int) : 0 ≤ b → 0 < d → b * d / d = b ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_truncate_middle (x : Int) (b : Int) (c : Int) :
      0 ≤ x → 0 < b → 0 < c → 0 < b * c ∧ b * x % (b * c) = b * (x % c) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_breakdown (x : Int) (y : Int) (z : Int) :
      0 ≤ x → 0 < y → 0 < z → 0 < y * z ∧ x % (y * z) = y * (x / y % z) + x % y ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_remainder_upper (x : Int) (d : Int) :
      0 ≤ x → 0 < d → x - d < x / d * d ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_remainder_lower (x : Int) (d : Int) : 0 ≤ x → 0 < d → x ≥ x / d * d ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.div_mod.lemma_fundamental_div_mod_converse_prove_auto («no%param» : Int) :
      (∀ (x : Int) (d : Int) (q : Int) (r : Int), (!d = 0 ∧ 0 ≤ r ∧ r < d) ∧ x = q * d + r → q = x / d) ∧
        (∀ (x : Int) (d : Int) (q : Int) (r : Int), (!d = 0 ∧ 0 ≤ r ∧ r < d) ∧ x = q * d + r → r = x % d) ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.div_mod.lemma_mul_mod_noop_general (x : Int) (y : Int) (m : Int) :
      0 < m → x % m * y % m = x * y % m ∧ x * (y % m) % m = x * y % m ∧ x % m * (y % m) % m = x * y % m ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.div_mod.lemma_mod_equivalence (x : Int) (y : Int) (m : Int) :
      0 < m → (x % m = y % m) = ((x - y) % m = 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_mul_equivalent (x : Int) (y : Int) (z : Int) (m : Int) :
      m > 0 →
        vstd.arithmetic.div_mod.is_mod_equivalent x y m →
          vstd.arithmetic.div_mod.is_mod_equivalent (x * z) (y * z) m ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mul_is_distributive_sub_auto («no%param» : Int) :
      (∀ (x : Int) (y : Int) (z : Int), x * (y - z) = x * y - x * z) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_strictly_increases (x : Int) (y : Int) : 1 < x → 0 < y → y < x * y ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_ordering (x : Int) (k : Int) (d : Int) :
      1 < d → 0 < k → 0 < d * k ∧ x % d ≤ x % (d * k) ∧ True :=
    sorry
  theorem vstd.arithmetic.div_mod.lemma_mod_breakdown (x : Int) (y : Int) (z : Int) :
      0 ≤ x → 0 < y → 0 < z → y * z > 0 ∧ x % (y * z) = y * (x / y % z) + x % y ∧ True :=
    sorry
  theorem vstd.arithmetic.logarithm.lemma_log0 (base : Int) (pow : Int) :
      base > 1 → 0 ≤ pow ∧ pow < base → vstd.arithmetic.logarithm.log base pow = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.logarithm.lemma_log_s (base : Int) (pow : Int) :
      base > 1 →
        pow ≥ base →
          pow / base ≥ 0 ∧
            vstd.arithmetic.logarithm.log base pow = 1 + vstd.arithmetic.logarithm.log base (pow / base) ∧ True :=
    sorry
  theorem vstd.arithmetic.logarithm.lemma_log_nonnegative (base : Int) (pow : Int) :
      base > 1 → 0 ≤ pow → vstd.arithmetic.logarithm.log base pow ≥ 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.logarithm.lemma_log_is_ordered (base : Int) (pow1 : Int) (pow2 : Int) :
      base > 1 →
        0 ≤ pow1 ∧ pow1 ≤ pow2 →
          vstd.arithmetic.logarithm.log base pow1 ≤ vstd.arithmetic.logarithm.log base pow2 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow0 (b : Int) : vstd.arithmetic.power.pow b 0 = 1 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_positive (b : Int) (e : Nat) :
      b > 0 → 0 < vstd.arithmetic.power.pow b e ∧ True :=
    sorry
  theorem vstd.arithmetic.logarithm.lemma_log_pow (base : Int) (n : Nat) :
      base > 1 → vstd.arithmetic.logarithm.log base (vstd.arithmetic.power.pow base n) = n ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_is_mul_pos (x : Int) (y : Int) :
      x ≥ 0 → x * y = vstd.arithmetic.internals.mul_internals.mul_pos x y ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_is_mul_recursive (x : Int) (y : Int) :
      x * y = vstd.arithmetic.internals.mul_internals.mul_recursive x y ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_nonzero (x : Int) (y : Int) : (!x * y = 0) = (!x = 0 ∧ !y = 0) ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_by_zero_is_zero (x : Int) : (x * 0 = 0 ∧ 0 * x = 0) ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.mul.lemma_mul_is_distributive (x : Int) (y : Int) (z : Int) :
      x * (y + z) = x * y + x * z ∧
        x * (y - z) = x * y - x * z ∧
          (y + z) * x = y * x + z * x ∧
            (y - z) * x = y * x - z * x ∧
              x * (y + z) = (y + z) * x ∧ x * (y - z) = (y - z) * x ∧ x * y = y * x ∧ x * z = z * x ∧ True :=
    sorry
  theorem vstd.arithmetic.mul.lemma_mul_cancels_negatives (x : Int) (y : Int) : x * y = (0 - x) * (0 - y) ∧ True :=
    sorry
                            ...
                            (∀ (x : Int) (y : Int), (0 < x ∧ 0 < y) ∧ 0 ≤ x * y → x ≤ x * y ∧ y ≤ x * y) ∧
                              (∀ (x : Int) (y : Int), 1 < x ∧ 0 < y → y < x * y) ∧
                                (∀ (x : Int) (y : Int), 0 < x ∧ 0 < y → y ≤ x * y) ∧
                                  (∀ (x : Int) (y : Int), 0 < x ∧ 0 < y → 0 < x * y) ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_mul_basics_auto («no%param» : Int) :
      (∀ (x : Int), 0 * x = 0) ∧
        (∀ (x : Int), x * 0 = 0) ∧ (∀ (x : Int), x * 1 = x) ∧ (∀ (x : Int), 1 * x = x) ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow1 (b : Int) : vstd.arithmetic.power.pow b 1 = b ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma0_pow (e : Nat) : e > 0 → vstd.arithmetic.power.pow 0 e = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma1_pow (e : Nat) : vstd.arithmetic.power.pow 1 e = 1 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_square_is_pow2 (x : Int) : vstd.arithmetic.power.pow x 2 = x * x ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.power.lemma_pow_multiplies (a : Int) (b : Nat) (c : Nat) :
      0 ≤ Int.natAbs (b * c) ∧
        vstd.arithmetic.power.pow (vstd.arithmetic.power.pow a b) c = vstd.arithmetic.power.pow a (Int.natAbs (b * c)) ∧
          True :=
    sorry
  ...
  theorem vstd.arithmetic.power.lemma_pow_distributes (a : Int) (b : Int) (e : Nat) :
      vstd.arithmetic.power.pow (a * b) e = vstd.arithmetic.power.pow a e * vstd.arithmetic.power.pow b e ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.power.lemma_pow_strictly_increases (b : Nat) (e1 : Nat) (e2 : Nat) :
      1 < b → e1 < e2 → vstd.arithmetic.power.pow b e1 < vstd.arithmetic.power.pow b e2 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_increases (b : Nat) (e1 : Nat) (e2 : Nat) :
      b > 0 → e1 ≤ e2 → vstd.arithmetic.power.pow b e1 ≤ vstd.arithmetic.power.pow b e2 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_strictly_increases_converse (b : Nat) (e1 : Nat) (e2 : Nat) :
      b > 0 → vstd.arithmetic.power.pow b e1 < vstd.arithmetic.power.pow b e2 → e1 < e2 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_increases_converse (b : Nat) (e1 : Nat) (e2 : Nat) :
      1 < b → vstd.arithmetic.power.pow b e1 ≤ vstd.arithmetic.power.pow b e2 → e1 ≤ e2 ∧ True :=
    sorry
        ...
        e2 ≤ e1 →
          x < vstd.arithmetic.power.pow b e1 →
            vstd.arithmetic.power.pow b e2 > 0 ∧
              x / vstd.arithmetic.power.pow b e2 < vstd.arithmetic.power.pow b (Int.natAbs (e1 - e2)) ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_mod (b : Nat) (e : Nat) :
      b > 0 → e > 0 → vstd.arithmetic.power.pow b e % b = 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.power.lemma_pow_mod_noop (b : Int) (e : Nat) (m : Int) :
      m > 0 → vstd.arithmetic.power.pow (b % m) e % m = vstd.arithmetic.power.pow b e % m ∧ True :=
    sorry
  theorem vstd.arithmetic.power2.lemma_pow2_pos (e : Nat) : vstd.arithmetic.power2.pow2 e > 0 ∧ True :=
    sorry
  theorem vstd.arithmetic.power2.lemma_pow2 (e : Nat) :
      vstd.arithmetic.power2.pow2 e = vstd.arithmetic.power.pow 2 e ∧ True :=
    sorry
  theorem vstd.arithmetic.power2.lemma_pow2_unfold (e : Nat) :
      e > 0 →
        vstd.arithmetic.power2.pow2 e = Int.natAbs (2 * vstd.arithmetic.power2.pow2 (Int.natAbs (e - 1))) ∧ True :=
    sorry
  ...
  theorem vstd.arithmetic.power2.lemma_pow2_strictly_increases (e1 : Nat) (e2 : Nat) :
      e1 < e2 → vstd.arithmetic.power2.pow2 e1 < vstd.arithmetic.power2.pow2 e2 ∧ True :=
    sorry
